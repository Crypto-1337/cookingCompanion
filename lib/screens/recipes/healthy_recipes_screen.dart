    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: FutureBuilder(
              future: SpoonacularService().getHealthyRecipes(5), // Nutze die getHealthyRecipes Methode
          ...
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () {
                // Logik, um neue gesunde Rezepte zu holen
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => HealthyRecipesScreen()),
                );
              },
              child: Text('Get New Healthy Recipes'),
